...
public class StockServiceImpl implements StockService {
    ...
    public StockServiceImpl(KiwoomTokenService kiwoomTokenService) {
    ...
    public void fetchAndStorePreviousDayUpperLimitStocks() throws IOException {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header("api-id", "ka10017") // Corrected API ID for upper limit stocks
            ...
            if (response.statusCode() == 200) {
                ...
                JsonNode stockList = responseBody.path("output");
